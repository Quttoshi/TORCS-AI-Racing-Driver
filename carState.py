...
class CarState(object):
    ...
    def __init__(self):
        ...
        self.fuel = None
        self.gear = None
        self.lastLapTime = 0.0  # Initialize with default value
        self.opponents = None
        self.racePos = None
        self.rpm = None
        self.speedX = None
    ...
    def setLastLapTimeD(self):
        # Ensure we get a float value, default to 0.0 if not available
        self.lastLapTime = self.getFloatD('lastLapTime') or 0.0
    
    def getLastLapTime(self):
        # Return the last lap time, defaulting to 0.0 if not set
        return self.lastLapTime or 0.0
